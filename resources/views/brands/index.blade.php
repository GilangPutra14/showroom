...
<div class="py-4 px-3 px-md-4">
    <div class="mb-3 mb-md-4 d-flex justify-content-between">
        <div class="h3 mb-0">Data Merk Motor</div>
    </div>
    ...
    <div class="card mb-3 mb-md-4">
        <div class="card-body">
            ...
            <div class="mb-3 mb-md-4 d-flex justify-content-between">
                <a href="{{ route('brands.create') }}" class="btn btn-primary btn-sm"><i class="gd-plus"></i> Tambah Merk Baru</a>
            </div>
                ...
                <table class="table mb-0">
                    <thead>
                        <tr>
                            ...
                            <th class="font-weight-semi-bold border-top-0 py-2">Nama Merk</th>
                            <th class="font-weight-semi-bold border-top-0 py-2" style="width: 500px">Deskripsi</th>
                            <th class="font-weight-semi-bold border-top-0 py-2 text-center">Logo</th>
