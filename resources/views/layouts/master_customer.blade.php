...
<head>
    ...
    <title>Enam Jaya Showroom</title>

    <!-- Google Font -->
    <link href="https://fonts.googleapis.com/css2?family=Lato:wght@300;400;700;900&display=swap" rel="stylesheet">

    <!--Favicon-->
    <link rel="shortcut icon" href="{{ asset('img/6j.png') }}">
...
<body>
    ...
    <div class="offcanvas-menu-wrapper">
        <div class="offcanvas__logo">
            <a href="/"><img src="{{ asset('img/6jaya-logo.png') }}" alt=""style="width: auto; height: 100px;"></a>
        </div>
        <div id="mobile-menu-wrap"></div>
        <ul class="offcanvas__widget__add">
            <li><i class="fa fa-clock-o"></i> Week day: 08:00 am to 18:00 pm</li>
            <li><i class="fa fa-envelope-o"></i> Info.enamjaya@gmail.com</li>
        </ul>
                ...
                <div class="row">
                    <div class="col-lg-7">
                        <ul class="header__top__widget">
                            <li><i class="fa fa-clock-o"></i> Week day: 08:00 am to end </li>
                            <li><i class="fa fa-envelope-o"></i> enamjayashowroom@gmail.com</li>
                        </ul>
                    </div>
                    <div class="col-lg-5">
                        <div class="header__top__right">
                            ...
                            <!-- Di bagian ini bisa di beri virtual tour -->
            ...
            <div class="row">
                <div class="col-lg-2">
                    <div class="header__logo">
                        <a href="/"><img src="{{ asset('img/6jaya-logo.png') }}" alt=""style="width: auto; height: 90px;"></a>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="footer__contact__option">
                            ...
                            <div class="option__item email"><i class="fa fa-envelope-o"></i> enamjaya-showroom@gmail.com</div>
                        </div>
                    </div>
                </div>
            </div>
