...
<head>
    <!-- Title -->
    <title>Sistem Admin Enam Jaya </title>
        ...
        <nav class="navbar flex-nowrap p-0">
            <div class="navbar-brand-wrapper d-flex align-items-center col-auto">
                ...
                <a class="navbar-brand navbar-brand-mobile" href="/">
                    <img class="img-fluid w-100" src="{{ asset('img/6j.png') }}" alt="Graindashboard">
                </a>
                <!-- End Logo For Mobile View -->

                <!-- Logo For Desktop View -->
                <a class="navbar-brand navbar-brand-desktop" href="/">
                    <img class="side-nav-show-on-closed" src="{{ asset('img/6j.png') }}" alt="Graindashboard" style="width: auto; height: 33px;">
                    <img class="side-nav-hide-on-closed" src="{{ asset('img/6j_logo.png') }}" alt="Graindashboard" style="width: auto; height: 200px;">
                </a>
            ...
            <ul id="sideNav" class="side-nav-menu side-nav-menu-top-level mb-0">
                ...
                <span class="side-nav-menu-icon d-flex mr-3">
                    <i class="gd-car"></i>
                        ...
                        <span class="side-nav-fadeout-on-closed media-body">Data Motor</span>
                    </a>
                </li>
                <!-- End Data Mobil -->
                ...
                <div class="row justify-content-between">
                    ...
                    <div class="col-lg text-center mb-3 mb-lg-0">
                        <ul class="list-inline mb-0">
                            ...
                            <li class="list-inline-item mx-2"><a class="link-muted" href="#"><i class="gd-youtube"></i></a></li>
                        </ul>
                    </div>

                    <div class="col-lg text-center text-lg-right">
                        &copy; 2023 EnamJayaMotor.
                    </div>
                </div>
            </footer>
        @show
